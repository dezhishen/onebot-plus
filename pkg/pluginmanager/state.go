...
// 	Plugin    plugin.OnebotPluginBase
// 	Status    PluginStatus
...
// func Register(filePath string, plugin plugin.OnebotPluginBase, rpcCli *rpcPlugin.Client, onebotCli api.OnebotAPiClientInterface) error {
